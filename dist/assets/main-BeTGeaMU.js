(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&a(o)}).observe(document,{childList:!0,subtree:!0});function s(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(n){if(n.ep)return;n.ep=!0;const i=s(n);fetch(n.href,i)}})();let p=null;async function O(){var e;if(p)return p;try{const t=await fetch("/data/profile_data/profile.json");if(!t.ok)throw new Error(`HTTP ${t.status}`);return p=await t.json(),console.log("✅ Profile loaded:",(e=p.personal)==null?void 0:e.name),p}catch(t){return console.error("❌ Failed to load profile:",t),null}}function N(){return p}const A={};function y(e,t){A[e.toLowerCase()]=t}function k(e){return A[e.toLowerCase()]}function P(e){window.location.hash=`#/${e}`}function R(){return(window.location.hash.slice(1)||"/home").replace(/^\//,"").toLowerCase()}const j=[{label:"Home",path:"home"},{label:"Research",path:"research"},{label:"Publications",path:"publications"},{label:"Academics",path:"academics"},{label:"Experience",path:"experience"},{label:"Projects",path:"projects"},{label:"Hobbies",path:"hobbies"},{label:"Contact",path:"contact"}];let f="home";function x(e){var a;const t=((a=e==null?void 0:e.personal)==null?void 0:a.nickname)||"YUSUF_SILICON";f=R();const s=j.map(n=>{const i=n.path===f;return`
  ...
  `}function U(){const e=document.querySelector(".header-inner");if(!e)return;e.addEventListener("click",a=>{const n=a.target.closest("[data-route]");if(n){a.preventDefault();const i=n.dataset.route;P(i)}});const t=document.getElementById("header-hamburger"),s=document.getElementById("header-nav");t&&s&&t.addEventListener("click",()=>{s.classList.toggle("header-nav--open");const a=t.querySelector(".material-symbols-outlined");a&&(a.textContent=s.classList.contains("header-nav--open")?"close":"menu")}),window.__updateActiveNav=a=>{f=a,document.querySelectorAll(".header-nav-link").forEach(n=>{const i=n.dataset.route===a;n.classList.toggle("header-nav-link--active",i)})}}function D(e){if(!e)return`
  ...
  `}function B(){const e=document.getElementById("theme-toggle-btn");e&&e.addEventListener("click",()=>{he(),L()})}function L(){const e=document.getElementById("theme-toggle-btn");if(!e)return;const t=e.querySelector(".material-symbols-outlined");if(!t)return;const s=document.documentElement.classList.contains("dark");t.textContent=s?"dark_mode":"light_mode"}function $(e){return e?e.replace(/^\.\.\//,"/data/"):""}function M(e,t){const s=(e==null?void 0:e.name)||"",a=(e==null?void 0:e.headline)||"",n=(e==null?void 0:e.description)||"",i=(e==null?void 0:e.description_highlight)||[],o=$(e==null?void 0:e.image),r=((t==null?void 0:t.researchInterests)||[]).slice(0,4).map(u=>`<span class="chip">${u.toUpperCase().replace(/\s+/g,"_")}</span>`).join("");let d=n;if(i.length){const u=[...i].sort((m,l)=>l.length-m.length);for(const m of u){const l=m.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");d=d.replace(new RegExp(`(${l})`,"gi"),'<span class="home-highlight">$1</span>')}}return`
  ...
  `}function F(e){var c,r,d,u,m,l,v,h,b,E,C;const t=((r=(c=e==null?void 0:e.research)==null?void 0:c.publications)==null?void 0:r.length)||0,s=(((u=(d=e==null?void 0:e.projects)==null?void 0:d.vlsi)==null?void 0:u.length)||0)+(((l=(m=e==null?void 0:e.projects)==null?void 0:m.iot)==null?void 0:l.length)||0)+(((h=(v=e==null?void 0:e.projects)==null?void 0:v.software)==null?void 0:h.length)||0),a=((E=(b=e==null?void 0:e.research)==null?void 0:b.theses)==null?void 0:E.length)||0,n=((C=e==null?void 0:e.certifications)==null?void 0:C.length)||0;return`
  ...
  `}function q(e,t){if(!e)return"";const a=[{icon:"mail",content:e.email||"",href:e.email?`mailto:${e.email}`:null},{icon:"school",content:"Google Scholar",href:e.google_scholar||null},{icon:"code",content:"github.com/yusuf-silicon",href:e.github||null},{icon:"location_on",content:(t==null?void 0:t.location)||""}].filter(i=>i.content).map(i=>`
      ...
      <ul class="research-area-list">${t.map(a=>`
        <li class="research-area-item">
          <div class="research-area-item-inner">
            <span class="material-symbols-outlined research-area-icon">${K(a.name)}</span>
  ...
  `}function ne(e){const t=(e||[]).filter(a=>a.status!=="active");return t.length?`
    <section class="content-section research-section">
  ...
  `}let g=null;async function ie(){if(g!==null)return g;try{const t=await(await fetch("https://api.allorigins.win/raw?url="+encodeURIComponent("https://scholar.google.com/citations?user=EJitK1IAAAAJ&hl=en&pagesize=100"),{signal:AbortSignal.timeout(5e3)})).text(),s=/citedby\s*=\s*['"](\d+)['"]/gi;let a;const n=[];for(;(a=s.exec(t))!==null;)n.push(parseInt(a[1],10));g=n.length?n:null}catch{g=null}return g}function oe(){return`
    <div class="pubs-header">
  ...
  `}function ce(e,t){var m;if(!e||!e.length)return"";const s=e.map(()=>0),n=[...e.map((l,v)=>({...l,citations:s[v]||0}))].sort((l,v)=>v.citations-l.citations),i=((m=n[0])==null?void 0:m.citations)||0,o=n.filter(l=>l.citations===i),c=e.filter(l=>l.featured),r=(l,v)=>l.map((h,b)=>`
  ...
  `}async function _(){const e=R(),t=N(),s=k(e),a=document.getElementById("page-content");if(a){if(s&&s.render){const n=await s.render(t);a.innerHTML=n,s.mount&&s.mount()}else e==="home"?a.innerHTML=`<div class="container-page" style="padding-top: 4rem; padding-bottom: 4rem;">
    ...
    </div>`;window.__updateActiveNav&&window.__updateActiveNav(e)}}function ve(){const e=localStorage.getItem("theme"),t=window.matchMedia("(prefers-color-scheme: dark)").matches;e==="dark"||!e&&t?document.documentElement.classList.add("dark"):document.documentElement.classList.remove("dark")}function he(){document.documentElement.classList.toggle("dark");const e=document.documentElement.classList.contains("dark");localStorage.setItem("theme",e?"dark":"light"),L()}async function pe(){ve(),me();const e=await O();if(!e){const n=document.getElementById("page-content");n&&(n.innerHTML='<p style="padding: 2rem; color: var(--error);">Failed to load profile data.</p>');return}const t=document.getElementById("app-header");t&&(t.innerHTML=x(e),U());const s=document.getElementById("theme-toggle-slot");s&&(s.innerHTML=H(),B());const a=document.getElementById("app-footer");a&&(a.innerHTML=D(e)),J(),w(),window.addEventListener("hashchange",_),_(),console.log("🔧 Yusuf Silicon Portfolio — Ready")}pe().catch(e=>{console.error("❌ App initialization failed:",e)});
